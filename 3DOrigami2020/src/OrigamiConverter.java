...
class OrigamiConverter {
    ...
    public static BufferedImage downloadOrigami(File f){
    ...
    public void origamiConverterTwosided( File front, File back , int width, int height, String outputName ){
